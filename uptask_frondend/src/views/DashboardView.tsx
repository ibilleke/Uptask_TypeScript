            ...
            {data.length
                                ...
                                <div className="min-w-0 flex-auto space-y-2">
                                    <div className='mb-2'>
                                        {isManager(project.manager, user._id)
                                            ...
                                            : <p className='font-bold text-xs uppercase bg-green-50 text-green-500 border-2 border-green-500 rounded-lg inline-block py-1 px-5'>Colaborador(a)</p>
                                        }
                                    </div>
                ...
                : (
                    <p className="text-center py-20">
                        ...
                        <Link
                            to={"/projects/create"}
                            className="text-fuchsia-500 py-20"
                        >Crear Proyecto</Link>
                    </p>
                  )
            }
